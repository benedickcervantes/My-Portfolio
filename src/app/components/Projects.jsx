...
const Projects = ({ setActiveSection }) => {
  ...
  const projects = [
    ...
    {
      title: 'Lakan Real Estate',
      description:
        'A modern property listing platform for browsing homes, condos, and commercial spaces. Next.js app with a Next.js backend, Prisma ORM, Supabase PostgreSQL, and AWS cloud. Currently in progress.',
      tags: ['Next.js', 'Prisma', 'Supabase', 'AWS'],
      github: 'https://github.com/benedickcervantes/lakan-real-estate.git',
      live: 'https://lakan-estate.vercel.app/',
      image: '/images/Lakan Web View.png',
      imageBg: 'bg-[#1A1714]',
      category: 'Web App',
      status: 'Ongoing',
      year: '2026',
